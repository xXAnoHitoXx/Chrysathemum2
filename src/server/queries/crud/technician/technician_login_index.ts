...
export const create_technician_login_index: Query<
    { user_id: string; technician_id: string },
    void
...
export const retrieve_technician_id_from_user_id: Query<
    { user_id: string },
...
export const delete_technician_login_index: Query<
    { user_id: string },
    void
> = async ({ user_id }, f_db) => {
    return db_query(
