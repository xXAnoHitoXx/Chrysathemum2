...
export const create_customers_appointments_entry: Query<{ customer_id:string, id:string, date: string }, void> = 
...
export const retrieve_customer_appointments
...
export const delete_customers_appointment_entry : Query<{ customer_id: string, id: string }, void> =
