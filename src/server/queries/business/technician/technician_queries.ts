...
export const mark_technician_active: Query<Technician, Technician> = async (
    technician,
    f_db,
) => {
    ...
    if (is_data_error(update))
        return update.stack("Mark Technician Inactive", technician.name);
    return active_tech;
};

export const mark_technician_inactive: Query<Technician, Technician> = async (
    technician,
    f_db,
) => {
    if (!technician.active) {
...
export const get_all_technicians: Query<
    void,
...
export const get_active_technicians: Query<void, Technician[]> = async (
    _,
    f_db,
) => {
