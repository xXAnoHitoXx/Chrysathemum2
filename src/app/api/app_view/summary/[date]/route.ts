...
import { get_bisquit } from "~/server/queries/crud/biscuits"; import { retrieve_earnings_information_of_date } from "~/server/queries/earnings/mod";
...
export async function GET(
    ...
    const query = pack(Bisquit.salon_selection)
        ...
        .bind((accounts, f_db) => {
            pack_nested(undefined as void, f_db)
